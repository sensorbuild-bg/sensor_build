    ...
    <div className={`${isBg ? 'bg-[#13182c]' : 'bg-white'} py-16 md:py-24`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className={`text-4xl md:text-5xl font-noah-bold mb-4 ${isBg ? 'text-white' : 'text-gray-900'}`}>
            {isBg ? 'Цени' : 'Prices'}
          </h1>

          <p className={`text-lg max-w-3xl mx-auto ${isBg ? 'text-white' : 'text-gray-600'}`}>
            {isBg
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* REFRESH */}
          <AnimatedDiv className={`rounded-lg p-8 border-2 border-[#388644] ${isBg ? 'bg-[#1a2342]' : 'bg-white'}`}>
            <h2 className={`text-2xl font-bold mb-4 ${isBg ? 'text-white' : 'text-gray-900'}`}>
          ...
          {/* FULL */}
          <AnimatedDiv className={`rounded-lg p-8 border-2 border-[#62b946] ${isBg ? 'bg-[#1a2342]' : 'bg-white'}`}>
            <h2 className={`text-2xl font-bold mb-4 ${isBg ? 'text-white' : 'text-gray-900'}`}>
