...
<div className="mt-4 grid gap-3 md:flex md:flex-wrap md:items-center">
  <div className="grid grid-cols-[110px_minmax(0,1fr)] items-center gap-3 md:flex md:items-center">
    <span
    ...
    <select
      ...
      className={`w-full rounded-xl px-4 py-2 text-sm font-semibold outline-none md:w-auto ${greenBorder} ${
...
на мобилно: всеки филтър на нов ред, label вляво, падащо меню вдясно

на desktop: пак ще си стоят нормално един до друг

Ако искаш само Voltage и IP да слизат на нов ред, а Socket да си стои горе, тогава ползвай това:
